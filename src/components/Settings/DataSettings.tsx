...
const DataSettings: React.FC = () => {
    ...
    const handleReset = async () => {
        ...
        const confirmed = window.confirm('?EST?S TOTALMENTE SEGURO? Esta acci?n es irreversible y borrar? todos tus servicios, gastos y configuraciones.');
        if (!confirmed) {
            ...
            <div style={{
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.5rem' }}>
                    ...
                    <div style={{ display: 'flex', gap: '8px' }}>
                        ...
                        >
                            {isConfirming ? '?S?, BORRAR TODO!' : 'Borrar Datos'}
                        </button>
                    </div>
                </div>
