...
import { PenTool, Calculator, ChevronRight, FileSpreadsheet, FileEdit } from 'lucide-react';
        ...
        <div style={{ paddingBottom: '4rem' }}>
            <div style={{ marginBottom: '2rem', padding: '0 0.25rem' }}>
                ...
                <p style={{ color: 'var(--text-muted)', fontSize: '1rem', fontWeight: '600', maxWidth: '90%' }}>
                    Importa la actividad real desde SmartD, corrige servicios puntuales o usa un cierre rápido cuando no vayas a registrar carrera por carrera.
                </p>
            </div>
                        ...
                        >
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                                <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                                    <div style={{ width: '38px', height: '38px', borderRadius: '12px', background: 'rgba(var(--accent-primary-rgb), 0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                    ...
                                    <div>
                                        ...
                                        <h3 style={{ margin: '0.15rem 0 0', fontSize: '1.05rem', fontWeight: '850', color: 'var(--text-primary)', letterSpacing: '-0.02em' }}>
                                            Reporte App Taxi (SmartD / Taxitronic)
                                        </h3>
                                    </div>
                                </div>
                                <p style={{ margin: 0, fontSize: '0.9rem', color: 'var(--text-secondary)', lineHeight: 1.45 }}>
                                    Importa aquí los servicios reales exportados desde SmartD o Taxitronic. Este es el flujo principal cuando ya tienes el reporte diario.
                                </p>
                    ...
                    <div style={{ display: 'grid', gap: '1.5rem' }}>
                        ...
                        >
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                                ...
                                <p style={{ margin: 0, fontSize: '0.9rem', color: 'var(--text-secondary)', lineHeight: 1.45 }}>
                                    Utiliza este modo solo cuando no vayas a registrar los servicios uno a uno. Aquí puedes guardar totales, kilómetros y gastos de toda la jornada.
                                </p>
                            </div>
                        </div>
