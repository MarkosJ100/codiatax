...
const History: React.FC = () => {
    ...
    const handleDelete = (id: number) => {
        if (confirm('ï¿½Estï¿½s seguro de borrar este servicio?')) {
            deleteService(id);
    ...
    const exportPDF = async () => {
        try {
            ...
            doc.text('CODIATAX - Histï¿½rico de Servicios', 14, 20);
            ...
            doc.text(`Importe Total: ${totalAmount.toFixed(2)} ï¿½`, 150, 48, { align: 'right' });
    ...
    return (
        <div style={{ paddingBottom: '100px', maxWidth: '600px', margin: '0 auto' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
                <div>
                    <h2 style={{ fontSize: '1.75rem', fontWeight: '950', color: 'var(--text-primary)', margin: 0, letterSpacing: '-0.02em' }}>Histï¿½rico</h2>
                    ...
                    >
                        <div style={{ 
                            ...
                            <h3 style={{ fontSize: '1rem', fontWeight: '900', color: 'var(--accent-primary)', marginBottom: '1rem', display: 'flex', alignItems: 'center', gap: '8px' }}>
                                ...
                                {editingService ? 'Editar Servicio' : 'Nuevo Registro Histï¿½rico'}
                            </h3>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
                                    ...
                                    <div>
                                        <label style={labelStyle}>Importe (ï¿½)</label>
                                        <input
                                            type="number"
                                            step="0.01"
                                            value={editAmount}
                ...
                {showFilters && (
                    ...
                    >
                        <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '1rem' }}>
                            ...
                            <h3 style={{ fontSize: '1rem', fontWeight: '900', margin: 0 }}>Filtros de bï¿½squeda</h3>
                        </div>
            ...
            <div>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '1.25rem', padding: '0 8px' }}>
                    ...
                    <div style={{ textAlign: 'right' }}>
                        <span style={labelStyle}>Recaudaciï¿½n</span>
                        <div style={{ fontSize: '1.6rem', fontWeight: '950', color: 'var(--text-primary)', letterSpacing: '-0.03em' }}>
                            {totalAmount.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}<span style={{ color: 'var(--accent-primary)', fontSize: '1.1rem', marginLeft: '2px' }}>ï¿½</span>
                        </div>
                    </div>
                </div>
                                                    ...
                                                    <div style={{ display: 'flex', alignItems: 'center', gap: '15px', marginLeft: '12px' }}>
                                                        <div style={{ textAlign: 'right' }}>
                                                            <div style={{ fontSize: '1.25rem', fontWeight: '950', color: 'var(--text-primary)', letterSpacing: '-0.02em' }}>
                                                                {service.amount.toFixed(2)}<span style={{ fontSize: '0.8rem', color: 'var(--accent-primary)', marginLeft: '1px' }}>ï¿½</span>
                                                            </div>
                                                        </div>
